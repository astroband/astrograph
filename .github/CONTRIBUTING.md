# Astroband Contributor Guide

Excited about Astrograph and want to make it better? We’re excited too!

Astroband is a community of developers just like you, striving to create the best tools and libraries around [Stellar](https://stellar.org). We welcome anyone who wants to contribute or provide constructive feedback, no matter the age or level of experience. If you want to help but don't know where to start, let us know, and we'll find something for you.
...
If you encounter a bug, please file an issue on GitHub at https://github.com/astroband/astrograph. If an issue you have is already reported, please add additional information or add a 👍 reaction to indicate your agreement.
...
In addition to reporting issues, a great way to contribute to Astrograph is to respond to other peoples' issues and try to identify the problem or help them work around it. If you’re interested in taking a more active role in this process, please go ahead and respond to issues. And don't forget to say "Hi" on [Astrograph Keybase](https://keybase.io/team/astrograph.public)!
...
Most of the features in Astrograph came from suggestions by you, the community! We welcome any ideas about how to make Astrograph better for your use case. Unless there is overwhelming demand for a feature, it might not get implemented immediately, but please include as much information as possible that will help people have a discussion about your proposal:
...
It’s important that every piece of code in Astrograph packages is reviewed by at least one core contributor familiar with that codebase. Here are some things we look for:
