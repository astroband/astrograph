// generated by github.com/vektah/dataloaden ; patched by @gzigzigzeo
...
func (l *TrustlineLoader) Clear(key string) {
	l.mu.Lock()
	delete(l.cache, key)
	l.mu.Unlock()
}
...
func (b *trustlineBatch) keyIndex(l *TrustlineLoader, key string) int {
