...
describe("constructor", () => {
  describe("memo parsing", () => {
    test(MemoType.None, () => {
      const xdr = "";
  ...
  describe("source account", () => {
    test("set from tx body", () => {
      const xdr = "AAAAAIO+zCWkYwJVyrzlIvttbpvuU0K/mEIVPESvJKGpkfKZAAAAZAAACvYAAAACAAAAAQAAAABbtxo6AAAAAFu3HiIAAAAAAAAAAQAAAAAAAAAKAAAABHRlc3QAAAABAAAABHRlc3QAAAAAAAAAAA==";
      const tx = transactionFactory.build({ txbody: xdr });
