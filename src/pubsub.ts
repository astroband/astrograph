...
export const DATA_ENTRY_CREATED = "DATA_ENTRY_CREATED";
export const DATA_ENTRY_UPDATED = "DATA_ENTRY_UPDATED";
export const DATA_ENTRY_REMOVED = "DATA_ENTRY_REMOVED";
